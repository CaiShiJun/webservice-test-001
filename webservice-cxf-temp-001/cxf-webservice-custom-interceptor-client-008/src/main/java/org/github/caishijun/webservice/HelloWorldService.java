 ...
 * 2018-08-14T18:39:32.419+08:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "HelloWorldService",
                  wsdlLocation = "http://localhost/helloWorld?wsdl",
                  targetNamespace = "http://webservice.caishijun.github.org/")
public class HelloWorldService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://webservice.caishijun.github.org/", "HelloWorldService");
    public final static QName HelloWorldPort = new QName("http://webservice.caishijun.github.org/", "HelloWorldPort");
    static {
        URL url = null;
        try {
