 ...
 * generated in the org.github.caishijun.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetRoleByUser_QNAME = new QName("http://webservice.caishijun.github.org/", "getRoleByUser");
    private final static QName _GetRoleByUserResponse_QNAME = new QName("http://webservice.caishijun.github.org/", "getRoleByUserResponse");
    private final static QName _GetRoles_QNAME = new QName("http://webservice.caishijun.github.org/", "getRoles");
    private final static QName _GetRolesResponse_QNAME = new QName("http://webservice.caishijun.github.org/", "getRolesResponse");
    private final static QName _Say_QNAME = new QName("http://webservice.caishijun.github.org/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://webservice.caishijun.github.org/", "sayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.github.caishijun.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.caishijun.github.org/", name = "getRoleByUser")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.caishijun.github.org/", name = "getRoleByUserResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.caishijun.github.org/", name = "getRoles")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.caishijun.github.org/", name = "getRolesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.caishijun.github.org/", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.caishijun.github.org/", name = "sayResponse")
