 ...
 * 2018-08-14T20:42:16.651+08:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "HelloWorldImplService",
                  wsdlLocation = "http://localhost:8080/cxf-webservice-spring-custom-interceptor-server-010/webservice/HelloWorld?wsdl",
...
public class HelloWorldImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/cxf-webservice-spring-custom-interceptor-server-010/webservice/HelloWorld?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldImplService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/cxf-webservice-spring-custom-interceptor-server-010/webservice/HelloWorld?wsdl");
        }
        WSDL_LOCATION = url;
    }
